export const STAFF_AVAILABILITY_PROJECTS = {
  ...
  couple_vlog_edit: {
    key: 'couple_vlog_edit',
    title: '커플 브이로그 유튜브 채널 편집',
    label: '편집 전담건',
    heading: '커플 브이로그 편집 가능 여부와 단가를 알려주세요.',
    intro: [
      '이번에 유튜브 채널 한 곳을 맡아 운영하게 되어 커플 브이로그 편집을 맡아주실 분을 찾고 있습니다.',
      '촬영은 저희 쪽에서 진행하고 편집만 전담해주시면 됩니다.',
    ],
    location: '원격 작업 (촬영본은 온라인으로 전달)',
    schedule: '촬영본 1~2시간 내외를 완성본 25~30분으로, 편당 기준',
    workload: '커플 브이로그 컷편집과 자막 작업',
    flow: '두 출연진이 사랑스럽게 투닥거리고 장난치는 장면을 살리는 컷편집과, 출연진을 놀리는 드립성 자막으로 재미를 만들어주는 편집',
    availableDescription: '커플 브이로그 편집 진행이 가능합니다.',
    ...
    preferredTimeWhenAvailable: '커플 브이로그 편집 진행 가능',
